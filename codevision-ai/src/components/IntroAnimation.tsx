    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-gradient-to-tr from-sky-500/15 via-indigo-500/15 to-purple-500/20 blur-[130px] pointer-events-none" />
          ...
          <div className="flex flex-col items-center text-center max-w-xl my-auto">
            ...
            <motion.h1
              ...
              className="font-display font-extrabold text-5xl sm:text-7xl lg:text-8xl tracking-tight mb-4 drop-shadow-[0_0_35px_rgba(56,189,248,0.45)]"
            >
            ...
            <div className="w-64 sm:w-80 h-1.5 rounded-full bg-slate-800/80 p-0.5 overflow-hidden border border-sky-500/20 shadow-[0_0_20px_rgba(56,189,248,0.3)]">
              <motion.div
                initial={{ width: '0%' }}
                animate={{ width: '100%' }}
